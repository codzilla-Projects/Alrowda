			    ...
			    <div class="tab-content" id="v-pills-tabContent">
			        ...
			        <div class="tab-pane fade show active" id="v-pills-firstsection" role="tabpanel" aria-labelledby="v-pills-firstsection-tab">
						...
						<div class="form-group">
						  ...
						  <label for="sh_website_logo" class="col-sm-4 control-label"> صورة الهوية او الشعار أبيض</label>

						  <div class="col-sm-12">

						    <img class="first_img" src="<?php echo get_option('sh_logo_light_img'); ?>" height="100" style="max-width:100%" />

						    <input class="first_img_url sh_half" type="text" name="sh_logo_light_img" size="60" value="<?php echo get_option('sh_logo_light_img'); ?>">
                        ...
                        <div class="form-group">
						  ...
						  <label for="sh_logo_light_img" class="col-sm-4 control-label"> صورة الهوية او الشعار ألوان</label>

						  <div class="col-sm-12">

						    <img class="third_img" src="<?php echo get_option('sh_logo_img'); ?>" height="100" style="max-width:100%" />

						    <input class="third_img_url sh_half" type="text" name="sh_logo_img" size="60" value="<?php echo get_option('sh_logo_img'); ?>">
			        ...
			        <div class="tab-pane fade" id="v-pills-secondsection" role="tabpanel" aria-labelledby="v-pills-secondsection-tab">
						...
						<div class="form-group">
							...
							<label for="sh_phone" class="col-sm-4 control-label"> رقم الهاتف الأول</label>
                        ...
                        <div class="form-group">
							...
							<label for="sh_phone2" class="col-sm-4 control-label">رقم الهاتف الثانى </label>

							<div class="col-sm-12">

								<input type="text" class="form-control" id="sh_phone2" name="sh_phone2" value="<?php echo get_option('sh_phone2'); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								...
								<input type="email" class="form-control text-right" id="sh_email" name="sh_email" value="<?php echo get_option('sh_email'); ?>">
					...
					<div class="tab-pane fade" id="v-pills-thirdsection" role="tabpanel" aria-labelledby="v-pills-thirdsection-tab">
                        ...
                        <div class="form-group">
							...
							<label for="sh_linkedin" class="col-sm-4 control-label">لينكد ان</label>

							<div class="col-sm-12">

								<input type="text" class="form-control" id="sh_linkedin" name="sh_linkedin" value="<?php echo get_option('sh_linkedin'); ?>">
